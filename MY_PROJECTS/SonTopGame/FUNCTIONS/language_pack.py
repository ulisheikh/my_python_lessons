lang_pack = {
    ...
    "en": {
        ...
        "T2": "The number I thought of is greater than {javob}",
        "T3": "The number I thought of is smaller than {javob}",
        "T4": "You guessed it!",
        ...
        "T9": "You thought of the number {son}",
        "T10": "                   ",
    ...
    "ru": {
        ...
        "T2": "Загаданное мной число больше {javob}",
        "T3": "Загаданное мной число меньше {javob}",
        "T4": "Вы угадали!",
